echo "Blind SSRF testing - append to parameters and add new parameters"
...
echo "Getting URL's with waybackurls"
waybackurls $1 > $1-ssrf.txt

echo "Getting URL's with gau"
gau $1 >> $1-ssrf.txt
...
ffuf -w $1-ssrf2.txt -u FUZZ -t 50 -c
